...
from app.handlers.careers import ManagerCareersDetailsHandler, ManagerCareersEditHandler, AdminCareersJobsListHandler, \
    ...
    AdminCareersJobApplicationEditHandler, AdminCareersJobApplicationDeleteHandler
...
from app.handlers.instructors import AdminInstructorsListHandler, AdminInstructorAddHandler, AdminInstructorDeleteHandler, \
    ...
    AdminInstructorRemoveAccessCurriculumHandler, AdminInstructorDeActivateHandler, AdminInstructorEditHandler, \
    AdminInstructorGradeHandler
...
# ADMIN URLS
    ...
    webapp2.Route('/admin/users/instructor/<instructor_id:\d+>/edit', AdminInstructorEditHandler, name="admin-instructor-edit"),
    webapp2.Route('/admin/users/instructor/<instructor_id:\d+>/grade', AdminInstructorGradeHandler, name="admin-instructor-grade"),
    ...
    webapp2.Route('/admin/users/instructor/<instructor_id:\d+>/curriculum/<curriculum_id:\d+>/remove-access', AdminInstructorRemoveAccessCurriculumHandler, name="admin-instructor-remove-access-curriculum"),
    ...
    webapp2.Route('/admin/careers/job/<job_id:\d+>/application/<application_id:\d+>/delete', AdminCareersJobApplicationDeleteHandler, name="admin-careers-application-delete"),
